...
@section('adminEdit')
    ...
    <body>
        <main>
            <form action="{{ route('adminEditComfirm', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="register_table">
                            <table>
                                <tr class="register_group">
                                    ...
                                    <th><input type="text" name="company" value="{{ $data->company }}"></th>
                                </tr>
                                <tr class="register_group">
                                    <th><label for="email">メールアドレス</label></th>
                                    <th><input type="email" name="email" value="{{ $data->email }}"></th>
                                </tr>
                                <tr class="register_group">
                                    <th><label for="industry">業種</label></th>
                                    <th><select name="industry">
                                            <option selected>{{ $data->industry }}</option>
                                ...
                                <tr class="register_group">
                                    ...
                                    <th><select name="occupation">
                                            <option value="" selected>{{ $data->occupation }}</option>
                                ...
                                <tr class="register_group">
                                    ...
                                    <th><input type="tel" name="tel" value="{{ $data->tel }}"></th>
                                </tr>
                                <tr class="register_group">
                                    <th><label for="area">勤務地</label></th>
                                    <th><select name="area">
                                            <option value="" selected>{{ $data->area }}</option>
                                ...
                                <tr class="register_group">
                                    ...
                                    <th>
                                        <textarea type="" name="title"cols="25" rows="2" value="">{{ $data->title }}
                                </textarea>
                                    </th>
                                </tr>
                                <tr class="register_group">
                                    ...
                                    <th>
                                        <textarea name="message" cols="50" rows="10" value="">{{ $data->message }}</textarea>
                                    </th>
                                </tr>
                            </table>
                        </div>
